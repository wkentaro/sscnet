...
if floor_file.exists():
    ...
    _, classRootId, _, _, _ = getobjclassSUNCG('floor',objcategory)
...
if ceiling_file.exists():
    ...
    _, classRootId, _, _, _ = getobjclassSUNCG('ceiling',objcategory)
    gridPtsLabel[gridPtsObjWorldInd] = classRootId
...
if 'nodeIndices' in roomStruct:
    ...
    for objId in roomStruct['nodeIndices']:
        ...
        if 'modelId' in object_struct:
            ...
            classRootName, classRootId, _, _, _ = getobjclassSUNCG(
                objname, objcategory
            )
            ...
            _, wallId, _, _, _ = getobjclassSUNCG('wall', objcategory)
